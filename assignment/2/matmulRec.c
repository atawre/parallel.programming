...
// Parallel Multiply: A[a] * B[b] => C[c], recursively.
void pmul(mat A, mat B, mat C, corners a, corners b, corners c) {
  corners aii[2][2], bii[2][2], cii[2][2];
  int i, j, m, n, p;
  ...
  cilk_spawn mul( A, B, C, aii[0][0], bii[0][0], cii[0][0] );
  cilk_spawn mul( A, B, C, aii[0][0], bii[0][1], cii[0][1] );
  cilk_spawn mul( A, B, C, aii[1][0], bii[0][0], cii[1][0] );
  mul( A, B, C, aii[1][0], bii[0][1], cii[1][1] );

  cilk_sync;

  cilk_spawn mul( A, B, C, aii[0][1], bii[1][0], cii[0][0] );
  cilk_spawn mul( A, B, C, aii[0][1], bii[1][1], cii[0][1] );
  cilk_spawn mul( A, B, C, aii[1][1], bii[1][0], cii[1][0] );
  mul( A, B, C, aii[1][1], bii[1][1], cii[1][1] );
